...
p1 = carla.Transform(carla.Location(x=-12.538, y=262, z=5), carla.Rotation(yaw=180))
p2 = carla.Transform(carla.Location(x=-11.3415, y=268, z=5), carla.Rotation(yaw=180))
p3 = carla.Transform(carla.Location(x=-11.34, y=265, z=5), carla.Rotation(yaw=180))
...
p1 = carla.Transform(carla.Location(x=-12, y=250.975, z=5), carla.Rotation(yaw=180))
p2 = carla.Transform(carla.Location(x=-11, y=252.975, z=5), carla.Rotation(yaw=180))
p3 = carla.Transform(carla.Location(x=-11, y=253.975, z=5), carla.Rotation(yaw=180))
...
p1 = carla.Transform(carla.Location(x=-12, y=265, z=5), carla.Rotation(yaw=180))
p2 = carla.Transform(carla.Location(x=-11, y=267, z=5), carla.Rotation(yaw=180))
p3 = carla.Transform(carla.Location(x=-11, y=250, z=5), carla.Rotation(yaw=180))
